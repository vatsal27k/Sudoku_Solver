...
class MyColorPanel1 extends JPanel
{
	...
	protected void paintComponent(Graphics g) {
        ...
        int w = getWidth();
        int h = getHeight();
//        Color color1 = new Color(29,17,40);
        Color color2 = new Color(218,214,214);
        Color color1 = new Color(72,48,77);
//        Color color2 = new Color(223,187,177);
        GradientPaint gp = new GradientPaint(300, 150, color1, 500, h, color2);
        g2d.setPaint(gp);
...
public class firstpan extends MyColorPanel1 implements ActionListener,MouseListener
{
	...
	public firstpan() {
		...
		Font f3=new Font("TimesRoman",Font.PLAIN,40);
		...
		mainimg.setBounds(40,120,200,200);
